...
(function ($) {
    ...
    $.extend($.fn.editableform.Constructor.prototype, {
        ...
        initInput: function() {
            ...
            var datetypes = 'datefield,datetimefield'.split(',');
            if(~$.inArray(this.input.type, datetypes)) {
                this.input.$input.find('input[type="text"]').addClass('form-control');
                if(emptyInputClass) {
                    this.input.options.inputclass = defaultClass;
                    this.input.$input.wrap('<div class="form-group"></div>');
                    this.input.$input.find('.input-group').addClass('input-group-sm');
                }
            }
